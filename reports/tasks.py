...
from .conf import REPORT_TASKS_QUEUE
...
@shared_task(ignore_result=True, bind=True, default_retry_delay=1 * 60, queue=REPORT_TASKS_QUEUE)
...
@shared_task(ignore_result=True, queue=REPORT_TASKS_QUEUE)
