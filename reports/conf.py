...
_DEFAULT_REPORT_TASKS_QUEUE = 'celery'
...
if 'schemamigration' in sys.argv:
    ...
    REPORT_TASKS_QUEUE = _DEFAULT_REPORT_TASKS_QUEUE
else:
    ...
    REPORT_TASKS_QUEUE = getattr(settings, 'REPORT_TASKS_QUEUE', _DEFAULT_REPORT_TASKS_QUEUE)
